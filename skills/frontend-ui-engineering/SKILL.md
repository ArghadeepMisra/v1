...
**Preceded by:** [planning-and-task-breakdown](../planning-and-task-breakdown/SKILL.md) or [spec-driven-development](../spec-driven-development/SKILL.md)
**Followed by:** [browser-testing-with-devtools](../browser-testing-with-devtools/SKILL.md)

**Typical sequence:** [planning-and-task-breakdown](../planning-and-task-breakdown/SKILL.md) → **frontend-ui-engineering** → [browser-testing-with-devtools](../browser-testing-with-devtools/SKILL.md) → [code-review-and-quality](../code-review-and-quality/SKILL.md)
...
```bash
bash skills/frontend-ui-engineering/scripts/verify.sh [--project-dir /path/to/project]
```
